...
def test_mixed_mapping(engine_and_base) -> None:
...
def test_relationship(engine_and_base) -> None:
    engine, Base = engine_and_base
...
def test_typed(engine_and_base) -> None:
    engine, Base = engine_and_base
...
def test_example(engine_and_base) -> None:
    engine, Base = engine_and_base
